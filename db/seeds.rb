...
mug6 = Mug.new(color: 'white and red', size: 'm', description: '', user: john, price_by_day: 5)
...
mug11 = Mug.new(color: 'white', size: 's', description: '', user: john, price_by_day: 4)
...
mug12 = Mug.new(color: 'gold', size: 'l', description: '', user: john, price_by_day: 12)
file = File.open('db/fixtures/images/mug_or.png')
mug12.photo.attach(io: file, filename: 'mug_gold.png', content_type: 'image/png')
mug12.save!

mug13 = Mug.new(color: 'red and black', size: 'm', description: '', user: john, price_by_day: 7)
...
mug14 = Mug.new(color: 'black', size: 'm', description: '', user: john, price_by_day: 4)
...
mug15 = Mug.new(color: 'white', size: 's', description: '', user: john, price_by_day: 5)
