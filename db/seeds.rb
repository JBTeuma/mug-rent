...
# Size: 's/m/l'
mug1 = Mug.new(color: 'Blanc ancien', size: 's', description: "Fais à la main par ma grand-mère, ce mug contient tous les mystères de l'Histoire !", user: john, price_by_day: 10)
...
mug9 = Mug.new(color: 'blanc et rouge', size: 's', description: "Coloré aux couleurs d'automnes, ce Mug est l'occasion idéale pour se replonger dans les idylles passées", user: john, price_by_day: 6)
...
mug13 = Mug.new(color: 'rouge et noir', size: 'm', description: "Ce Mug est fait pour celles et ceux qui qui ont toujours cette tendance à se prendre pour une coccinelle !", user: john, price_by_day: 7)
